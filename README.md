...
The study employs umbrella sampling to construct a minimum free energy pathway (MFEP) connecting structurally defined immature-like and mature-like CA conformations. Sampling windows are combined using standard free-energy reconstruction techniques to obtain the underlying free-energy landscape along the chosen reaction coordinates.

Discrete states along the MFEP are subsequently analyzed using end-state free-energy calculations to quantify energetic contributions and to characterize intermediate conformations encountered along the transition.
