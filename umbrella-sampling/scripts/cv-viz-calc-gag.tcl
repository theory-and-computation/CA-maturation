...
# used on structures indexed by full gag polyprotein
...
# ntd
mol modselect 0 0 resid 149 to 278 and backbone and chain $c
...
# ctd
mol addrep 0
mol modselect 1 0 resid 278 to 354 and backbone and chain $c
...
set sel [atomselect 0 "resid 149 to 178 and backbone and not hydrogen and chain ${c}"]
set 1m [measure center $sel weight mass]

set sel [atomselect 0 "resid 264 to 268 and backbone and not hydrogen and chain ${c}"]
set 2m [measure center $sel weight mass]

set sel [atomselect 0 "resid 269 to 278 and backbone and not hydrogen and chain ${c}"]
set 3m [measure center $sel weight mass]

set sel [atomselect 0 "resid 304 to 313 and backbone and not hydrogen and chain ${c}"]
set 4m [measure center $sel weight mass]

set sel [atomselect 0 "resid 329 to 336 and backbone and not hydrogen and chain ${c}"]
